    ...
    <div className="min-h-screen flex flex-col bg-surface-container-low">
      ...
      <main className="flex-1 max-w-[1100px] mx-auto w-full px-6 py-10">
        ...
        <div className="mb-10">
          ...
          <p className="text-secondary text-sm leading-relaxed max-w-2xl">Terakhir diperbarui: <strong>1 Oktober 2023</strong>. Kebijakan ini menjelaskan bagaimana Daurly mengumpulkan, menggunakan, dan melindungi data pribadi Anda.</p>
        </div>
        <div className="flex gap-10 items-start">
          ...
          <article className="flex-1 min-w-0 space-y-10">
            ...
            <div className="bg-primary-container border border-[#BFDBFE] rounded-xl p-6">
              <p className="text-sm text-primary font-semibold leading-relaxed">Dengan menggunakan Daurly, Anda menyetujui pengumpulan dan penggunaan data sesuai kebijakan ini. Pertanyaan? Hubungi <a href={CONTACT_EMAIL_MAILTO} className="font-bold underline">{CONTACT_EMAIL}</a> atau Chat Admin.</p>
            </div>
          </article>
        </div>
      </main>
