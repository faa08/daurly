...
import ProcessFlowInfographic from "@/components/ProcessFlowInfographic";
import SDGsImpact from "@/components/SDGsImpact";
import AIGreenAssistantSection from "@/components/AIGreenAssistantSection";
import WasteToWorth from "@/components/WasteToWorth";
import GreenStatisticsInfographic from "@/components/GreenStatisticsInfographic";
    ...
    <>
      ...
      <main>
        ...
        <div className="quick-links-row">
          ...
          <Link href="/edukasi" className="quick-link-item">
            <div className="quick-link-icon-box">
        ...
        <WasteToWorth />
        <AIGreenAssistantSection />
        
        <FeaturedProducts searchQuery={searchQuery} />

        <SDGsImpact />
        <GreenStatisticsInfographic />
