    ...
    <div className="bg-surface-container-low py-10">
      <div className="max-w-[1100px] mx-auto w-full px-6">
        ...
        <div className="mb-10">
          ...
          <p className="text-secondary text-sm leading-relaxed max-w-2xl">Terakhir diperbarui: <strong>1 Oktober 2023</strong>. Harap baca syarat dan ketentuan sebelum menggunakan layanan Pelataran UMKM.</p>
        </div>
